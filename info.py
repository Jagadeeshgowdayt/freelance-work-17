# Please paste your new released Python code here.
...
PICS = (environ.get('PICS', 'https://graph.org/-07-16-3027')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1308498708').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002428424894').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002428424894')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002428424894')).split()]  # For Multiple Id Use One Space Between Each.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/qbt.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/J7NET_BOT')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/J7NET_BOT')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'J7NET_BOT') # Support Chat Link Without https:// or @
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/J7NET_BOT')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/J7NET_BOT') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
...
MSG_ALRT = environ.get('MSG_ALRT', 'im J7NET_BOT who are you..?')
